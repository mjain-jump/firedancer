...
snapio_snoop_footprint_cb( fd_topo_t const *     topo,
                           fd_topo_obj_t const * obj ) {
  return fd_snapio_snoop_footprint( VAL("worker_cnt"), VAL("stake_log_max") );
}
...
snapio_snoop_new_cb( fd_topo_t const *     topo,
                     fd_topo_obj_t const * obj ) {
  FD_TEST( fd_snapio_snoop_new( fd_topo_obj_laddr( topo, obj->id ), VAL("worker_cnt"), VAL("stake_log_max") ) );
}
